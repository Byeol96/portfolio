...
<script src = "js/PopUp_DeleteJs.js" charset="UTF-8"></script>
<link type="text/css" rel="stylesheet" href="css/PopUp_DeleteCss.css"/>
</head>
<body>
	<div id="total">
		<form action="ProjectServlet1">
			<input type="hidden" name="command" value="MenuDelete"/>
			<div id="fileInput">
				<br>
				<br>
				<br>
				...
				<br> <input type="submit" value="메뉴 삭제" id="submitA" />
			</div>
					...
					<table id="table${menus[0].getCategoryId()}">
						<c:forEach var="menu" items="${menus}">
							<tr>
								...
								<td><input type="checkbox" name="deleteMenuName"
